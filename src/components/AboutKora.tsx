...
const capabilities = [
	...
	{ icon: BadgeDollarSign, label: "Vendas" },
];
				...
				<div className="grid lg:grid-cols-2 gap-12 lg:gap-20 items-center">
					<div>
						...
						<p className="text-muted-foreground text-lg mb-6">
							A Kora é uma empresa de tecnologia especializada em transformar a
							gestão de empresas B2B através de consultoria estratégica e
							soluções personalizadas.
						</p>
						<p className="text-muted-foreground">
							Nossa atuação vai além da implantação de sistemas. Mergulhamos na
							realidade de cada cliente para identificar oportunidades, otimizar
							processos e garantir que a tecnologia trabalhe a favor do seu
							crescimento.
						</p>
					</div>
