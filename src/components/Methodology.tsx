...
const steps = [
	...
	},
	{
		...
		title: "Mapeamento",
		description:
			"Documentamos processos e identificamos oportunidades de melhoria",
	},
	{
		number: "03",
		title: "Implantação",
						...
						<div className="space-y-8">
							{steps.map((step, index) => (
								...
								>
									...
									<div className="hidden md:flex items-center justify-center w-12 h-12 rounded-full bg-primary/20 border-2 border-primary flex-shrink-0 relative z-10 mt-12">
										<ArrowRight
